...
namespace PriceOptimizerCoreApplication.web.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ServicesController(EmailHelper emailHelper, IRazorViewToStringRenderer razorViewToStringRenderer, Common common)
        {
        ...
        [HttpGet]
        public IActionResult AboutServices()
        {
            return PartialView("~/Views/Services/_PartialAboutServices.cshtml");
        }
        [HttpGet]
